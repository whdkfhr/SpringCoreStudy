...
+ 주문과 할인 정책
  ...
  + "주문 도메인 협력, 역할, 책임"
  <img width="806" alt="스크린샷 2020-12-14 오후 3 03 53" src="https://user-images.githubusercontent.com/26809312/102045969-a3528500-3e1d-11eb-9649-191b4c21ac8b.png">
  
  + "참고" : 실제로는 주문 데이터를 DB에 저장하겠지만, 예제는 단순히 주문 결과를 반환.
  
  + "주문 도메인 전체"
  <img width="807" alt="스크린샷 2020-12-14 오후 3 15 36" src="https://user-images.githubusercontent.com/26809312/102046734-3e982a00-3e1f-11eb-990e-34e6320e8d14.png">

  + 역할과 구현을 분리해서 자유롭게 구현 객체를 조립할 수 있게 설계.
  
  + "주문 도메인 클래스 다이어그램"
  <img width="805" alt="스크린샷 2020-12-14 오후 3 57 46" src="https://user-images.githubusercontent.com/26809312/102049941-33e09380-3e25-11eb-8755-bf23cdda7735.png">
